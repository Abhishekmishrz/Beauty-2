          ...
          <div className="col-md-6">
            <div className="tp-header-contact-info d-flex align-items-center" style={{ height: '45px' }}>
              <div className="tp-header-contact-item d-flex align-items-center" style={{ marginRight: '20px' }}>
                ...
                <a href="tel:+919876543210" className="tp-header-contact-text" style={{ color: '#000000', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', height: '45px' }}>
                  +91 98765 43210
                </a>
              </div>
              <div className="tp-header-contact-item d-flex align-items-center">
                ...
                <a href="mailto:hello@urbanthali.com" className="tp-header-contact-text" style={{ color: '#000000', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', height: '45px' }}>
