              ...
              <div className="row" style={{ marginTop: '20px', marginBottom: '40px' }}>
                ...
                <div className="col-lg-4 mb-4">
                  <div style={{ 
                    ...
                    <h4 style={{ color: '#1f2937', marginBottom: '10px' }}>Phone</h4>
                    <p style={{ color: '#6b7280', margin: 0 }}>+91 98765 43210</p>
                  </div>
                </div>
                ...
                <div className="col-lg-4 mb-4">
                  <div style={{ 
                    ...
                    <h4 style={{ color: '#1f2937', marginBottom: '10px' }}>Email</h4>
                    <p style={{ color: '#6b7280', margin: 0 }}>hello@urbanthali.com</p>
                  </div>
                </div>
                ...
                <div className="col-lg-4 mb-4">
                  <div style={{ 
                    ...
                    <h4 style={{ color: '#1f2937', marginBottom: '10px' }}>Address</h4>
                    <p style={{ color: '#6b7280', margin: 0 }}>123 Food Street, Spice Market<br />Delhi, India 110001</p>
                  </div>
                </div>
              </div>
